...
//to filter the data depending on the selected parent value
  ...
  Future<void> addProduct() async {
    try {
      if (selectedMainImage == null) {
        SnackBarHelper.showErrorSnackBar('Please Choose A Main Image !');
        return; // stop the function
      }

      // Validate other required fields here
  ...
  filterSubcategory(category) {
    ...
    selectedBrand = null; // Reset brand

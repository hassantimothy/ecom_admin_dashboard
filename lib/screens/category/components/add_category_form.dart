      ...
      child: Form(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            color: isDarkMode ? bgDarkColor : bgColor,
                ...
                children: [
                  ElevatedButton(
                    style: ElevatedButton.styleFrom(
                      ...
                      backgroundColor:
                          isDarkMode ? secondaryDarkColor : secondaryColor,
                    ),
                    onPressed: () {
                  ...
                  ElevatedButton(
                    style: ElevatedButton.styleFrom(
                      foregroundColor: Colors.white,
                      backgroundColor:
                          isDarkMode ? primaryDarkColor : primaryColor,
                    ),
                    onPressed: () {
...
void showAddCategoryForm(BuildContext context, Category? category) {
  showDialog(
    ...
    builder: (BuildContext context) {
      final isDarkMode = Get.isDarkMode;
      return AlertDialog(
        backgroundColor: isDarkMode ? bgDarkColor : bgColor,
        title: Center(

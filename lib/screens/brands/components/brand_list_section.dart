// lib/screens/brands/components/brand_list_section.dart
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        color: Theme.of(context).cardColor, // Theme-based background color
        ...
        children: [
          Text(
            ...
            style: Theme.of(context)
                .textTheme
                .titleMedium, // Theme-based text styling
          ),

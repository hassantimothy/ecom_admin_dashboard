        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            color: Theme.of(context)
                .scaffoldBackgroundColor, // Dynamically adapts to light/dark mode
                  ...
                  ElevatedButton(
                    style: ElevatedButton.styleFrom(
                      ...
                      backgroundColor: Theme.of(context)
                          .secondaryHeaderColor, // Uses theme's secondary color
                    ),
                    onPressed: () {
...
void showBrandForm(BuildContext context, Brand? brand) {
  showDialog(
    ...
    builder: (BuildContext context) {
      return AlertDialog(
        backgroundColor: Theme.of(context)
            .scaffoldBackgroundColor, // Adapts to the theme's background color
        title: Center(
            child: Text('Add Brand'.toUpperCase(),
                style: Theme.of(context)
                    .textTheme
                    .titleLarge)), // Theme-based text styling

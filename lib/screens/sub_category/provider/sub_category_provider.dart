// lib/screens/sub_category/provider/sub_category_provider.dart
    ...
    try {
      ...
      if (response.isOk) {
        ...
        if (apiResponse.success == true) {
          ...
          developer.log('Sub category added');
        } else {
  ...
  updateSubCategory() async {
    try {
      if (subCategoryForUpdate != null) {
        SnackBarHelper.showErrorSnackBar('No subcategory selected for update');
        return;
      }
      ...
      if (response.isOk) {
        ...
        if (apiResponse.success == true) {
          clearFields();
          SnackBarHelper.showSuccessSnackBar(apiResponse.message);
          developer.log('Sub Category Updated');
          _dataProvider.getAllSubCategory();
        } else {
          SnackBarHelper.showErrorSnackBar(
              'Failed to add Sub Category: ${apiResponse.message}');

// lib/core/data/data_provider.dart
...
class DataProvider extends ChangeNotifier {
  ...
  //should complete getAllCategory
  ...
  void filterCategories(String keyword) {
    if (keyword.isEmpty) {
      ...
      _filteredCategories = _allCategories.where((category) {
        return category.name?.toLowerCase().contains(lowerKeyword) ?? false;
      }).toList();
    }
    notifyListeners();
  }
...
// complete filterSubCategories
  ...
  void filterSubCategories(String keyword) {
    if (keyword.isEmpty) {
      ...
      _filteredSubCategories = _allSubCategories.where((subcategory) {
        return subcategory.name?.toLowerCase().contains(lowerKeyword) ?? false;
      }).toList();
    }
    notifyListeners();
  }
    ...
    if (keyword.isEmpty) {
      ...
      _filteredProducts = _allProducts.where((product) {
        ...
        final subCategoryNameContainsKeyword = product.proSubCategoryId?.name
                ...
                .contains(lowerKeyword) ??
            false;
        // could add more conditions here if there are more fields to match against
  ...
  //should complete getAllNotifications
  ...
  //should complete filterNotifications
  ...
  //should complete calculateOrdersWithStatus

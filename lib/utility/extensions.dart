// lib/utility/extensions.dart

import 'package:flutter/cupertino.dart';
import 'package:provider/provider.dart';
// Importing various providers used in the app for managing states and data
...
// Extension to quickly access different providers in the context
extension Providers on BuildContext {
  // Accessing DataProvider without needing to listen for changes
  DataProvider get dataProvider =>
      Provider.of<DataProvider>(this, listen: false);

  // Accessing other specific providers in the app
